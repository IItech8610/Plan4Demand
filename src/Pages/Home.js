                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        At present, we are engaged in a multi-faceted role,
                        collectively serving as a team of professionals in the
                        field of data science, development, and design. As data
                        scientists, we harness the power of data to extract
                        valuable insights and drive informed decision-making.
                        Our expertise extends to web development, where we craft
                        and construct a wide array of websites. Simultaneously,
                        as UI/UX designers, we channel our creativity into
                        crafting designs for web applications and mobile apps,
                        infusing them with aesthetic appeal. Our collective
                        responsibility encompasses both the technical
                        underpinnings of website performance and capacity,
                        ensuring they operate seamlessly, as well as content
                        creation to enhance the overall user experience.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="row love-row wow fadeIn">
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".1s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Always believe in hard-work in Our profession</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                ...
                <div className="row">
                  <div className="col-md-4 col-sm-6 col-xs-12 about-col">
                    <div className="about-image">
                      <img
                        src="https://static.vecteezy.com/system/resources/previews/006/260/729/original/initial-letter-f-tech-logo-design-template-element-eps10-vector.jpg"
                        alt="FTech"
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      ...
                      <p className="wow fadeIn">
                        We are a team of professionals based in Kolkata, India,
                        specializing in web development, data science, and
                        design. We design and build digital products with simple
                        and beautiful code. We specialize in custom web theme
                        development and love what I do. We derive immense
                        satisfaction from creating a diverse range of projects,
                        spanning from small business websites to highly
                        interactive web applications. If you represent a
                        business seeking to establish a compelling online
                        presence or an employer interested in expanding your
                        team, please don't hesitate to reach out to us. We're
                        here to collaborate and bring your digital vision to
                        life.{" "}
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                      FTech was a real pleasure to work with and
                                      we look forward to working with him again.
                                      He’s definitely the kind of developer you
                                      can trust with a project from start to
                                      finish.”
                                      <br />
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      They are clear communicator with the
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      They have done a fantastic job overall.
                  ...
                  <div class="col-md-12 col-sm-12 map-col">
                    <div class="google-maps">
                      <div class="map-wrap">
                        <iframe
                          title="google-maps"
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d497511.2310550484!2d79.87932771420108!3d13.047985948484722!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5265ea4f7d3361%3A0x6e61a70b6863d433!2sChennai%2C%20Tamil%20Nadu!5e0!3m2!1 sin!2sin!4v1694510826865!5m2!1sen!2sin"
                          width="100%"
                          height="450"
                          style={{ border: "0" }}
                          allowfullscreen=""
